...
| No Shift Handoff record exists when your shift starts | Open a Shift Handoff record yourself, note that no handoff was received, and reconstruct what you can | Shift Lead | Open cases, recent alerts, tool status, what could not be reconstructed |
